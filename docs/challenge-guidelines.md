...
* the percentiles (p50, p90 and p99) of a dimension from the posts
  (accuracy of the value can be traded with the memory usage efficiency)

The payload should look like the one from the example described below.
